...
function fish_prompt
    set_color 2B5BB7 # Set foreground color to blue
    echo -n '┌─<'

    if test "$USER" = "root"
        set_color C80A12 # Set foreground color to red for root user
    else
        set_color blue # Set foreground color to blue for regular user
    end
    ...
    set_color white # Set foreground color to white(directory)
    echo -n (pwd)
	...
	echo -n '#'
        ...
        set_color 2B5BB7 # Set foreground color to blue for regular user
	echo -n '>'
    end
...
#function fish_prompt
#    echo (prompt_pwd) "❯ "
#echo (set_color 00d3b8)"➜" (set_color 3daee9)(prompt_pwd)(set_color yellow) "✗ "
#end
